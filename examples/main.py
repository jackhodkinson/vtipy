...
# TODO: remove assertion or figure out why it doesnt work.
...
#os.system('python temp_plot.py {}'.format(temp_data_filename))

tc.ramp_temperature(100)
...
tc.hold( hold_time = 60, temp_resolution = 2)
